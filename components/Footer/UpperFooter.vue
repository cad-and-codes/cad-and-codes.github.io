          ...
          <div class="flex justify-center text-teal-600 sm:justify-start">
            ...
            <div class="flex lg:flex-1">
              <a href="/" class="-m-1.5 p-1.5">
                ...
                <!-- Logo image -->
                <img class="h-8 w-auto lg:px-20" src="~/assets/images/logo.svg" alt="" />
              </a>
            </div>
          </div>

          <p class="mt-6 max-w-md font:basic text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
            <b>CAD & CODES</b> is a top-tier <b>Software Development</b> &
            <b>Digital Marketing</b> company based on <b>Bangladesh.</b>
          </p>
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
          ...
          <div class="text-center sm:text-left">
            ...
            <ul class="mt-8 space-y-4 text-sm">
              ...
              <li>
                <a class="group flex justify-center gap-1.5 ltr:sm:justify-start" href="#">
          ...
          <div class="text-center sm:text-left">
            ...
            <ul class="mt-8 space-y-4 text-sm">
              <li>
                <a class="flex items-center justify-center gap-1.5 ltr:sm:justify-start" href="#">
                  ...
                  <span class="flex-1 text-gray-700">contact@cadandcodes.com</span>
                </a>
              </li>
              ...
              <li>
                <a class="flex items-center justify-center gap-1.5 ltr:sm:justify-start" href="#">
                  ...
                  <span class="flex-1 text-gray-700">+880 123 456 789</span>
                </a>
              </li>

              <li class="flex items-start justify-center gap-1.5 ltr:sm:justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="size-5 shrink-0 text-gray-900" fill="none"
                  viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round"
...
import UpperFooterLink from "~/components/Footer/UpperFooterLink.vue";
</script>
