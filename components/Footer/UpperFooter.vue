<template>
  <footer class="bg-white">
    <div
      class="mx-auto max-w-screen-xl px-4 pb-6 pt-6 sm:px-6 lg:px-8 lg:pt-10"
    >
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
          ...
          <p
            class="mt-6 max-w-md font:basic text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left"
          >
          ...
          <div class="text-center sm:text-left">
            ...
            <ul class="mt-8 space-y-4 text-sm">
              ...
              <li>
                ...
                >
                  <span
                    class="text-gray-900 hover:text-blue-900 transition duration-300"
                  >
                    Live Chat
                  </span>
